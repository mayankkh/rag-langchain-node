...
const processPdf = async (pdfpath = './pdfs/stay_policy.pdf') => {
...
const init = async () => {
  ...
  const query = 'What is check-in time?'; 
...
const main = async () => {
  // Create index and store chunks and embeddings from pdfs/stay-policy.pdf
